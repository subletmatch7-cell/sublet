  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">My Listings Dashboard</h1>
        ...
        <div className="flex justify-between items-center mb-6">
          ...
          <div className="flex space-x-3">
            <button
              ...
              className="px-4 py-2 text-sm text-gray-600 hover:text-[#3BC0E9] transition-colors"
            >
              Refresh
            </button>
            <Link
              to="/lister/dashboard/create"
              className="px-4 py-2 text-sm bg-gradient-to-r from-[#3BC0E9] to-[#95BDCB] text-white rounded-lg hover:shadow-md transition-all"
            >
              + New Listing
            </Link>
          </div>
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                        <div className="flex space-x-3">
                          <Link
                            ...
                            className="text-[#3BC0E9] hover:text-blue-700 transition-colors"
                          >
                            View
                          </Link>
                          <Link
                            to={`/lister/dashboard/edit/${listing._id}`}
